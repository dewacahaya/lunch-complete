                ...
                <div class="col my-3 h-auto">
                    <div class="p-3 d-flex flex-column align-items-start bg-primary rounded-4">
                        <button class="btn btn-success mb-3">
                            <a href="addProduct.php" class="text-decoration-none text-white">Add Product</a>
                        </button>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="w-25 h-25">
                                                    <a href="img/<?php echo $row['product_image'] ?>" target="_blank">
                                                        <img class="img-fluid" src="img/<?php echo $row['product_image'] ?>" alt="ini gambar">
                                                    </a>
                                                </td>
                                                <td>
                                                    <a class="text-decoration-none text-success" href="editProduct.php?id=<?php echo $row['product_id'] ?>">Edit</a> ||
                                                    <a class="text-decoration-none text-danger" href="deleteData.php?idp=<?php echo $row['product_id'] ?>" onclick="return confirm('Yakin Hapus Data Ini ?')">Delete</a>
                                                </td>
                                            </tr>
                                        <?php }
                                    } else { ?>
